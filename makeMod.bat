...
echo    2. Build z_bp.iwd
echo    3. Build ruleset .IWD files
echo    4. Build mod.ff
echo.
echo    0. Exit
echo.
...
echo _________________________________________________________________
echo.
echo  Building z_bp.iwd:
echo    Deleting old z_bp.iwd file...
del z_bp.iwd
echo    Adding images...
7za a -r -tzip z_bp.iwd images\*.iwi > NUL
echo    Adding sounds...
7za a -r -tzip z_bp.iwd sound\*.mp3 > NUL
7za a -r -tzip z_bp.iwd sound\*.wav > NUL
echo    Adding weapons...
7za a -r -tzip z_bp.iwd weapons\mp\*_mp > NUL
echo    Adding OpenWarfare standard rulesets...
7za a -r -tzip z_bp.iwd rulesets\openwarfare\*.gsc > NUL
7za a -r -tzip z_bp.iwd rulesets\leagues.gsc > NUL
echo    Adding empty mod.arena file...
7za a -r -tzip z_bp.iwd mod.arena > NUL
echo  New z_bp.iwd file successfully built!
