...
readyUpPeriod()
{
	...
	self.readyUpText = createFontString( "objective", 1.4 );
...
waitForPlayers()
{
	...
	waitingForPlayersText = createServerFontString( "objective", 1.4 );
...
checkServerPassword()
{
	...
	serverNoPassword = createServerFontString( "objective", 1.4 );
...
createHudElements()
{
	...
	game["readyUpTextAlliesNotReady"] = createServerFontString( "objective", 1.4 );
	...
	game["readyUpTextAxisNotReady"] = createServerFontString( "objective", 1.4 );
...
showTimeLimitCountdown( timeLimit )
{
	...
	limitCountdownTimer = createServerTimer( "objective", 1.7 );
