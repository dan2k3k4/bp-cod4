...
onPlayerSpawned()
{
	...
	self.rangeFinder.alignX = "center";
	self.rangeFinder.alignY = "middle";
	self.rangeFinder.horzAlign = "center";
	self.rangeFinder.vertAlign = "middle";
	self.rangeFinder.sort = 1001;
	self.rangeFinder.x = 130;
	self.rangeFinder.y = 130;
