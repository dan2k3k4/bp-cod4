...
onPrecacheGameType()
{
	...
	for ( i=0; i < weaponsOrder.size; i++ ) {
		...
		// Make sure we don't load more than 86 elements
		if ( newElement == 85 ) {
			break;
		}
	}
...
onEndGame( winningPlayer )
{
	if ( isDefined( winningPlayer ) && isPlayer( winningPlayer ) )
		[[level._setPlayerScore]]( winningPlayer, [[level._getPlayerScore]]( winningPlayer ) + 50 );
}
...
onTimeLimit()
{
	...
	if ( isDefined( winningPlayer ) ) {
		...
		level notify("gg_winner",winningPlayer);
	} else {
...
loadAllowedWeapons()
{
	...
	game["gunGameWeapons"][ "kar98_mp" ] = "bp_weapon_kar98";
	precacheShader( "bp_weapon_kar98" );
	...
	game["gunGameWeapons"][ "dragunov_mp" ] = "weapon_remington700";
	...
	game["gunGameWeapons"][ "m21_mp" ] = "weapon_m40a3";
	precacheShader( "weapon_m40a3" );
