...
onSpawnPlayer()
{
	...
	if ( !isDefined( self.carryIcon ) && self.pers["team"] == game["attackers"] && !level.bombPlanted )
	{
		self.carryIcon = createIcon( "hud_suitcase_bomb", 25, 25 );
		self.carryIcon setPoint( "CENTER", "CENTER", 225, 145 );
		self.carryIcon.alpha = 0.4;
	}
...
updateGametypeDvars()
{
	...
	level.scr_sd_bombtimer_modifier = getdvarx( "scr_sd_bombtimer_modifier", "int", 0, 0, level.bombTimer - 5 );
