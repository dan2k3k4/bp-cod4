...
onOvertime()
{
	...
	for ( index = 0; index < level.players.size; index++ )
	{
		level.players[index] thread maps\mp\gametypes\_hud_message::oldNotifyMessage( &"MP_SUDDEN_DEATH", &"OW_OBJECTIVES_LMS", undefined, (1, 0, 0), "mp_last_stand" );
		level.players[index] setClientDvars( "g_compassShowEnemies", 1 );
	}
