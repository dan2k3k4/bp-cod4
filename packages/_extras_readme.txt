...
"All weapons no sway" 
  The z_openwarfare.iwd file in this folder removes the stock sway
  from all the weapons including sniper rifles. This file should
  replace the default z_openwarfare.iwd included with the mod.
