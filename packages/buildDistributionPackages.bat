...
if not exist OpenWarfare mkdir OpenWarfare >NUL
rd /s /q OpenWarfare >NUL
if not exist OpenWarfare-Distribution mkdir OpenWarfare-Distribution >NUL
rd /s /q OpenWarfare-Distribution >NUL
...
call _buildIWD.bat
copy /Y ..\z_openwarfare.iwd OpenWarfare\%_MODHOME% > NUL

set _MODWEAPONS=weapons\fixes+nogunsway
call _buildIWD.bat
copy /Y ..\z_openwarfare.iwd "OpenWarfare\Extras\All weapons no sway" > NUL

set _MODWEAPONS=weapons\fixes+nogunsway+sniper
call _buildIWD.bat
copy /Y ..\z_openwarfare.iwd "OpenWarfare\Extras\Snipers with increased distance" > NUL

set _MODWEAPONS=weapons\thecompany
call _buildIWD.bat
copy /Y ..\z_openwarfare.iwd "OpenWarfare\Extras\The Company Hub weapons" > NUL
